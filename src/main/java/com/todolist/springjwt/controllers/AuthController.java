...
//   User Authentication after hitting the api of "/signin" with JWT token. 
...
//  User Registration after hitting the http request "/signup". with role assigning in backend
